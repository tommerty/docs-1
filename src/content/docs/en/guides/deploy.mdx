...
1. Choose a host that supports **continuous deployment** (e.g. [Netlify](/en/guides/deploy/netlify/), [Vercel](/en/guides/deploy/vercel/) or [Cloudflare Pages](en/guides/deploy/cloudflare/)) and import your Git repository as a new site/project.
